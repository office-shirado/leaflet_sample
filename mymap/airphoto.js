...
//シームレス空中写真
var seamlessphoto = L.tileLayer('https://cyberjapandata.gsi.go.jp/xyz/seamlessphoto/{z}/{x}/{y}.jpg',
	{attribution: "<br><a href='http://www.gsi.go.jp/' target='_blank'>国土地理院</a>：シームレス空中写真", maxZoom: 23, maxNativeZoom: 18, opacity: 1.0});


//背景レイヤグループ設定
var overlayMapsArray = [
	[seamlessphoto , "シームレス空中写真" , "シームレス空中写真" ],
...
//表示ＯＮ・ＯＦＦスイッチ
var overlay_Maps_On_Off = new Array(overlayMapsArray.length);

//透過度
var overlay_Maps_Opacity = new Array(overlayMapsArray.length);

//透過度初期化（1.0）
for (var i = 0; i < overlayMapsArray.length; i++){
	overlay_Maps_Opacity[i] = 1.0;
}
